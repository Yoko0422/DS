...
class MainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main" do
    assert_difference('Main.count') do
      post mains_url, params: { main: { file1: @main.file1, file2: @main.file2, file3: @main.file3, file4: @main.file4, name: @main.name, text: @main.text, title: @main.title } }
    end
  ...
  test "should update main" do
    patch main_url(@main), params: { main: { file1: @main.file1, file2: @main.file2, file3: @main.file3, file4: @main.file4, name: @main.name, text: @main.text, title: @main.title } }
